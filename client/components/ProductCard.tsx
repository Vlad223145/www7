...
const productsData: Record<string, Product> = {
  "sparklesoft-hand-wash": {
    ...
    description:
      "Experience the ultimate in hand care with Sparklesoft hand wash. Our advanced formula combines gentle cleansing agents with moisturizing elements to leave your hands feeling incredibly soft and clean.",
    composition:
  ...
  "soothesuds-hand-wash": {
    ...
    description:
      "Soothesuds hand wash delivers exceptional comfort and protection for sensitive skin. Our hypoallergenic formula is specially crafted with calming botanical extracts.",
    composition:
  ...
  "vitalguard-hand-wash": {
    ...
    description:
      "Vitalguard hand wash offers superior antimicrobial protection without compromising on gentleness. Formulated with advanced cleansing technology and enriched with vitamin E.",
    composition:
  ...
  "freshcrisp-hand-wash": {
    ...
    description:
      "Freshcrisp hand wash provides an invigorating cleansing experience with its refreshing formula. Infused with natural citrus extracts and essential oils.",
    composition:
  ...
  "velvetclean-hand-wash": {
    ...
    description:
      "Velvetclean hand wash delivers luxurious cleansing with an ultra-smooth, velvety texture. This premium formula combines silk proteins and shea butter.",
    composition:
  ...
  "refreshrinse-hand-wash": {
    ...
    description:
      "Refreshrinse hand wash offers the perfect balance of effective cleansing and gentle care. Formulated with cooling menthol and eucalyptus extracts.",
    composition:
  ...
  "cleanscent-hand-wash": {
    ...
    description:
      "Cleanscent hand wash features a signature aromatic blend that elevates your handwashing routine. This premium formulation combines the finest botanical extracts.",
    composition:
  ...
  "clean-plus-hand-wash": {
    ...
    description:
      "Clean Plus hand wash delivers enhanced cleansing power with added antibacterial protection. This advanced formula eliminates 99.99% of harmful bacteria.",
    composition:
  ...
  "zenguard-hand-wash": {
    ...
    description:
      "Zenguard hand wash provides ultimate protection with calming aromatherapy benefits. This unique formula combines powerful antimicrobial agents with stress-relieving oils.",
    composition:
  ...
  "purelux-hand-wash": {
    ...
    hoverImage:
      "https://cdn.prod.website-files.com/65fbb5117e4ee1d7a1fe121f/66223551115d6051274fb427_product-image-01.jpg",
    description:
      "Purelux hand wash represents the pinnacle of luxury hand care, combining premium ingredients with exceptional performance. This exclusive formula features rare botanical extracts.",
    composition:
...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const handleImageHover = (e: React.MouseEvent, show: boolean) => {
    const hoverImg = e.currentTarget.querySelector(
      "img:last-child",
    ) as HTMLImageElement;
    if (hoverImg) {
