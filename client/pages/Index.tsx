...
export default function Index() {
                ...
                <div style={{ position: "relative" }}>
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor: "rgb(255, 255, 255)",
                        boxShadow: "rgba(0, 0, 0, 0.25) 0px 5px 25px 0px",
                        display: "flex",
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderBottomWidth: "1px",
                          borderColor:
                            "rgb(0, 0, 0) rgb(0, 0, 0) rgb(230, 230, 230)",
                          display: "flex",
                          flexShrink: "0",
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            style={{
                              borderColor:
                                "rgb(230, 230, 230) rgb(0, 0, 0) rgb(0, 0, 0)",
                              borderTop: "1px solid rgb(230, 230, 230)",
                              borderTopStyle: "solid",
                              borderTopWidth: "1px",
  ...
  width: 16px;"&gt;&lt;g fill="none" fill-rule="evenodd"&gt;&lt;polygon fill="#F05022" points="7 7 1 7 1 1 7 1"&gt;&lt;/polygon&gt;&lt;polygon fill="#7DB902" points="15 7 9 7 9 1 15 1"&gt;&lt;/polygon&gt;&lt;polygon fill="#00A4EE" points="7 15 1 15 1 9 7 9"&gt;&lt;/polygon&gt;&lt;polygon fill="#FFB700" points="15 15 9 15 9 9 15 9"&gt;&lt;/polygon&gt;&lt;/g&gt;&lt;/svg&gt;'
                              ...
                              <a
                                href="https://handly-wbs.webflow.io/checkout"
                                style={{
                                  alignItems: "center",
                                  backgroundColor: "rgb(0, 0, 0)",
                                  borderBottomLeftRadius: "5px",
                        ...
                        >
                          ...
                          <div style={{ textAlign: "center" }}>
                            ...
                            <a
                              href="https://handly-wbs.webflow.io/shop"
                              style={{
                                backgroundColor: "rgb(0, 0, 0)",
                                borderBottomLeftRadius: "5px",
                                borderBottomRightRadius: "5px",
